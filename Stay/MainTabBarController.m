...
- (instancetype)init{
    if (self = [super init]){
        ...
        SYBrowseViewController *storeController = [[SYBrowseViewController alloc] init];
        AdBlockViewController *adBlockController = [[AdBlockViewController alloc] init];
        ...
        self.tabBarItems = @[
            ...
            [FCTabBarItem ofDescriptor:@{
                ...
                @"deselect":@{
                    @"image": [ImageHelper sfNamed:@"slash.circle" font:FCStyle.sfSymbolL2 color:FCStyle.fcThirdBlack]
                },
                @"offsetY":@(2)
            }],
            [FCTabBarItem ofDescriptor:@{
            ...
            [FCTabBarItem ofDescriptor:@{
                ...
                @"deselect":@{
                    @"image": [ImageHelper sfNamed:@"gearshape" font:FCStyle.sfSymbolL2 color:FCStyle.fcThirdBlack]
                }
            }],
        ];
        
        FCNavigationController *adBlockNavigationController = [[FCNavigationController alloc]
