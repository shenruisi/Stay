...
browser.runtime.onMessage.addListener((request, sender, sendResponse) => {
    ...
    if ("darkmode" == request.from) {
        ...
        if ("fetchLog" == request.operate) {
            ...
            let videoInfoListRes = mergeVideoInfoList();
            console.log("--------snifferFetchVideoInfo---videoInfoListRes---------",videoInfoListRes)
            sendResponse({ body: {videoInfoList: videoInfoListRes} })  
        }
